import {
  buildSessionContext,
  createAgentSession as createBaseAgentSession,
...
import telemetry from "../../new-relic.ts";
import { withTelemetry } from "../btw-session.mjs";

const createAgentSession = withTelemetry({
  createSession: createBaseAgentSession,
